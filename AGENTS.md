...
| `codecompanion/` | WIP plan for the nvim CodeCompanion rebuild (tracked, not stowed). `00-overview.md` first; `findings.md` holds all measured evidence and is cited by the numbered step files, which are one self-contained work packet each |
