...
| `reviewer-quick` | sonnet | medium | Quick review or sanity/gut check on small diffs ("quick look", "is this fine"), or triage/classify issues and failures | Standard code review → `reviewer`; audits or risky changes → `auditor` |
