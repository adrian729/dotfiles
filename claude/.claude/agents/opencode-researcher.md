...
effort: low
---
Run `opencode-task <name> --agent researcher "Run subagent: researcher. Task: <task>"` in a throwaway worktree. Return the result verbatim. Use a descriptive, unique name for the worktree related to the task.
